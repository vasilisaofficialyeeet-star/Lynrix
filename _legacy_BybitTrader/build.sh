#!/bin/bash
# build.sh — Build BybitTrader macOS app
...
echo "═══════════════════════════════════════════════"
echo "  BybitTrader Build Script"
echo "  Config: $CONFIG"
echo "═══════════════════════════════════════════════"

# Step 1: Build C++ core library
echo ""
echo "▶ Building C++ trading core..."
mkdir -p "$BUILD_DIR"
cd "$BUILD_DIR"
...
cd "$SCRIPT_DIR"
xcodegen generate
echo "✓ BybitTrader.xcodeproj generated"
...
echo "═══════════════════════════════════════════════"
echo "  ✓ Build complete!"
echo "  App: $(find ~/Library/Developer/Xcode/DerivedData -name 'BybitTrader.app' -type d 2>/dev/null | head -1 || echo 'Check DerivedData')"
echo "═══════════════════════════════════════════════"
